...
import com.cn.expnsr.service.InterestService;
...
/**
 * REST controller for managing {@link com.cn.expnsr.domain.Interest}.
 */
@RestController
@RequestMapping("/api")
public class InterestResource {
    ...
    public ResponseEntity<InterestDTO> updateInterest(
        ...
        InterestDTO result = interestService.update(interestDTO);
        return ResponseEntity
            .ok()
    ...
    public ResponseEntity<List<InterestDTO>> getAllInterests(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
