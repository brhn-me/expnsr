...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RECURRINGBILLS_LIST actions', async () => {
    ...
    it('dispatches FETCH_RECURRINGBILLS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RECURRINGBILLS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RECURRINGBILLS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RECURRINGBILLS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RECURRINGBILLS actions', async () => {
      const expectedActions = [
        {
