...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './deposit.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DEPOSIT_LIST actions', async () => {
    ...
    it('dispatches FETCH_DEPOSIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DEPOSIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DEPOSIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DEPOSIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DEPOSIT actions', async () => {
      const expectedActions = [
        {
