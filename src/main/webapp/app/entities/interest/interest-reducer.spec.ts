...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './interest.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INTEREST_LIST actions', async () => {
    ...
    it('dispatches FETCH_INTEREST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_INTEREST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_INTEREST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_INTEREST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_INTEREST actions', async () => {
      const expectedActions = [
        {
