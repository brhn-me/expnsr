...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FIXEDDEPOSIT_LIST actions', async () => {
    ...
    it('dispatches FETCH_FIXEDDEPOSIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FIXEDDEPOSIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FIXEDDEPOSIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FIXEDDEPOSIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FIXEDDEPOSIT actions', async () => {
      const expectedActions = [
        {
